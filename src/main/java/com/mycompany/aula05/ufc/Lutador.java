...
public class Lutador {
    ...
    public void apresentar(){
        ...
        System.out.println("-----------------------------------------");
        System.out.println("Chegou o grande dia! Apresentamos o Lutados "+nome);
    ...
    public void ganharLuta(){ this.vitorias++;}
    public void perderLuta(){this.derrotas++;}
    public void empatarLuta(){ this.empates++;}
